...
public class Print {
    ...
    private void drawHeroStats() {
        ...
        String maxHealth = String.valueOf(gameSession.getHero().getMaxHealth());
        String currentHealth = String.valueOf(gameSession.getHero().getCurrentHealth());
        ...
        drawColoredString(String.valueOf(gameSession.getHero().getAgility()), TextColor.ANSI.GREEN, posX + "Agility: ".length(), posY + 2);
        drawColoredString("Strength: ", TextColor.ANSI.WHITE, posX, posY + 3);
        drawColoredString(String.valueOf(gameSession.getHero().getStrength()), TextColor.ANSI.RED, posX + "Strength: ".length(), posY + 3);
        drawColoredString("Coins: ", TextColor.ANSI.WHITE, posX, posY + 4);
        drawColoredString(String.valueOf(gameSession.getHero().getCoinCount()), TextColor.ANSI.YELLOW, posX + "Coins: ".length(), posY + 4);

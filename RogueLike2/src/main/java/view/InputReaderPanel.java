...
public class InputReaderPanel extends MyPanel {
    ...
    private void drawPanel() {
        textBuffer.drawRectangle(panelPosition, this.panelSize, TextCharacter.fromCharacter(' ', themeStyle.getForeground(), themeStyle.getForeground())[0]);
        textBuffer.fillRectangle(new TerminalPosition(panelPosition.getColumn() + 1, panelPosition.getRow() + 1), new TerminalSize(this.panelSize.getColumns() - 2, panelSize.getRows() - 2), TextCharacter.fromCharacter(' ', themeStyle.getBackground(), themeStyle.getBackground())[0]);

...
public class Level {
    ...
    private Item generateTypeItem(Coordinate coordinate) {
        ...
        return switch (itemType) {
            case SWORD -> new Sword(coordinate, false);
            case AXE -> new Axe(coordinate, false);
            case ELIXIRBLUE -> new ElixirBlue(coordinate, false);
            case ELIXIRRED -> new ElixirRed(coordinate, false);
            case ELIXIRGREEN -> new ElixirGreen(coordinate, false);
            case ELIXIRYELLOW -> new ElixirYellow(coordinate, false);
            case MEAT -> new Meat(coordinate, false);
            case CHAPMAN -> new Chapman(coordinate, false);
            case COIN -> new Coin(coordinate, Coin.generateAmountCoin(), false);
            case SCROLDEATH -> new ScrollDeath(coordinate, false);
            case SCROLSTRENGTH -> new ScrollStrength(coordinate, false);
            default -> new ScrollAgility(coordinate, false);
        };
    }

...
//        MyButton continueSavedGame = new MyButton(
//                new GameEvent.ColoredText("Continue saved game", TextColor.ANSI.BLACK, TextColor.ANSI.WHITE_BRIGHT), TextColor.ANSI.GREEN,
//                () -> {
//
//                });
...
//        startMenu.addButton(continueSavedGame);
...
//        MyButton startNewGame = new MyButton(new GameEvent.ColoredText("Start new game", TextColor.ANSI.BLACK, TextColor.ANSI.WHITE_BRIGHT), TextColor.ANSI.GREEN, () -> {
//            createNewGame();
//            gameSession.setGameState(GameSession.GameKa.IN_GAME);
//        });
...
//        gameOver.addButton(startNewGame);
